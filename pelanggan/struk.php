...
// 1. Ubah akses dari 'barber' menjadi 'pelanggan'
...
$pelanggan_id = $_SESSION['id_user'] ?? $_SESSION['user_id'] ?? $_SESSION['id'] ?? 0;

// 2. Query disesuaikan agar pelanggan hanya bisa melihat struk miliknya sendiri
$query = "SELECT t.*, a.tanggal, a.no_antrian, 
          ...
          WHERE t.id = $transaksi_id AND a.pelanggan_id = '$pelanggan_id'";
...
<body>
    ...
    <script>
        window.addEventListener('load', function() {
            // Optional: Uncomment the next line to strictly auto-print right off the bat,
            // but providing the print button is usually better UX so it doesn't loop block them.
            // window.print();
        });
    </script>
</body>
